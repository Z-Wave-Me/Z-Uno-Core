...
#define ZUNO_METER_ELECTRIC_KWH(GETTER, RESETTER)								ZUNO_METER(ZUNO_METER_TYPE_ELECTRIC, METER_RESET_ENABLE, ZUNO_METER_ELECTRIC_SCALE_KWH, METER_SIZE_FOUR_BYTES, METER_PRECISION_TWO_DECIMALS, GETTER, RESETTER)
#define ZUNO_METER_GAS(GETTER, RESETTER)									ZUNO_METER(ZUNO_METER_TYPE_GAS, METER_RESET_ENABLE, ZUNO_METER_GAS_SCALE_METERS3, METER_SIZE_FOUR_BYTES, METER_PRECISION_THREE_DECIMALS, GETTER, RESETTER)
#define ZUNO_METER_WATER(GETTER, RESETTER)									ZUNO_METER(ZUNO_METER_TYPE_WATER, METER_RESET_ENABLE, ZUNO_METER_WATER_SCALE_METERS3, METER_SIZE_FOUR_BYTES, METER_PRECISION_THREE_DECIMALS, GETTER, RESETTER)
