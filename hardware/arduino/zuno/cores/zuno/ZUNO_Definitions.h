...
#define ZUNO_CORES_SW_VERSION_MINOR 		09
...
#define ZUNO_EXT_INT2 	2

#define ZUNO_ISR_INT2   ZUNO_ISR_ZEROX
...
#define ZUNO_SETUP_ISR_INT2(FUNCTION_NAME)  	__code __at (ZUNO_ISR_TABLE_ADDR + 6) 	ZUNO_ISR_DESCRIPTION ISR_VEC_ZERX =  { 0x02, FUNCTION_NAME}
